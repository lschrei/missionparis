...
<?php
$resultSet = $pdo->query('SELECT COUNT(Date_consultation) AS consult FROM Consulte ORDER BY Article_Id DESC LIMIT 1');
...
$array = [$consult['consult'] . ' vues', $art['cn1'] . ' articles', $consultation['cn2'] . ' consultations ces 7 derniers jours'];
