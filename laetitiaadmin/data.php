...
<?php
$resultSet = $pdo->query('SELECT Id FROM Consulte ORDER BY Id DESC LIMIT 1');
...
$array = [$consult['Id'] . ' vues', $art['cn1'] . ' articles', $consultation['cn2'] . ' consultations ces 7 derniers jours'];
